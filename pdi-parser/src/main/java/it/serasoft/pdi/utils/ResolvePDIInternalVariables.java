...
public class ResolvePDIInternalVariables {
    ...
    public static String internalProcessDirectories(String baseDir, String value) {
        return value.replace("${Internal.Job.Filename.Directory}", baseDir).replace("${Internal.Transformation.Filename.Directory}", baseDir);
    }
}
