...
import org.serasoft.pdi.model.ProcessMetadata;
import org.serasoft.pdi.parser.JobParser;
import org.serasoft.pdi.parser.TransformationParser;
import org.serasoft.pdi.utils.ConsoleOutputModule;
...
public class PDIAnalyzer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PDIAnalyzer pdiTool = new PDIAnalyzer();
        if (cmdLine.hasOption("filename")) {
            // Read and process a single file
            pdiTool.analyzeFile(cmdLine.getOptionValue("filename"), recurseDir, followLinks);
        } else if (cmdLine.hasOption("srcDir")) {
            // Read and process a directory of files
            pdiTool.analyzeFiles(cmdLine.getOptionValue("srcDir"), recurseDir, followLinks);
        } else {
    ...
    private void analyzeFile(String filename, boolean recurse, boolean followLinks) {
    ...
    private void analyzeFiles(String srcDir, boolean recurse, boolean followLinks) {
