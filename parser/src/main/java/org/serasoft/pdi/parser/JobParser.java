...
import org.serasoft.pdi.utils.ResolvePDIInternalVariables;
                ...
                switch (eventType) {
                    case XMLStreamReader.START_ELEMENT:
                        ...
                        if (metadataPath.path().equals("/job/entries")) {
                            parseEntries(xmlStreamReader, metadataPath, processMetadata.getName(), items);
                        } else if (metadataPath.path().equals("/job/hops")) {
                            parseHops(xmlStreamReader, metadataPath, processMetadata, items);
...
*/
                ...
                switch (eventType) {
                    case XMLStreamReader.START_ELEMENT:
                        ...
                        if (elementName.equals("hop")) {
                            ProcessHop h = parseHop(xmlStreamReader, metadataPath, items);
                ...
                switch (eventType) {
                    ...
                    case XMLStreamReader.END_ELEMENT:
                        ...
                        if (elementName.equals("hop")) {
                            ...
                            elementAnalyzed = true;
                            ProcessItem ifrom = items.get(from);
                            ProcessItem ito = items.get(to);
                            if (ifrom != null && ito != null)
                                hop = new ProcessHop(ifrom, ito);
                        }
                        break;
                }
    ...
    private void parseEntries(XMLStreamReader xmlStreamReader, MetadataPath metadataPath, String procName, Map<String, ProcessItem> items) {
                ...
                switch (eventType) {
                    case XMLStreamReader.START_ELEMENT:
                        ...
                        if (elementName.equals("entry")) {
                            ProcessItem item = parseEntry(xmlStreamReader, metadataPath, procName);
