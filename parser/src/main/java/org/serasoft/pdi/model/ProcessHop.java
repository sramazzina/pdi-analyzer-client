...
public class ProcessHop {
    ...
    public ProcessHop(ProcessItem from, ProcessItem to, String name) {
        this.from = from;
        this.to = to;
        this.name = name;
    }

    public ProcessHop(ProcessItem from, ProcessItem to) {
        this.from = from;
        this.to = to;
    }
    ...
    public ProcessItem getFrom() {
        return from;
    }

    public ProcessItem getTo() {
        return to;
    }
}
